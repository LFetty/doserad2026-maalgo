...
class FluenceVolumeLayer(nn.Module):
    ...
    def __init__(self, machine_config: MachineConfig, 
        ...
        # field_size is already specified in physical beam coordinates (mm).
        # Do not rescale it by the CT voxel spacing here; doing so inflates the
        # projected aperture whenever the patient grid spacing differs from 1 mm.
        WT_max = W_field / 2.0
        HT_max = H_field / 2.0
